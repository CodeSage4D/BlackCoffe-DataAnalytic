...
#     fog_index = 0.4 * (avg_sentence_length + percentage_complex_words) if percentage_complex_words else 0
...
# datastructure_file = "Output Datastructure.xlsx"
